...
@Login_Invalid_Email
  Scenario: Login Invalid Email
   ...
   When User press " LOG IN " 
   Then User see "Please input valid email."
   
@Login_Invalid_Password
  Scenario: Invalid Password
   Given User enters "yash.aventador.lambo@gmail.com" "yashcha" credentials
   And User press " LOG IN " 
   Then User see "Invalid email or password"
  
@Login_Invalid_Password  
  Scenario: Invalid Password2
 	Given User enters "yash.aventador.lambo@gmail.com" "yashc" credentials
  And User press " LOG IN " 
...
@Login_No_Password
  Scenario: Login No Password
   ...
   And User enters "yash.aventador.lambo@gmail.com" "" credentials
   When User press " LOG IN " 
